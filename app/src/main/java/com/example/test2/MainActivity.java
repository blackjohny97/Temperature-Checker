...
public class MainActivity extends AppCompatActivity {
    ...
    Button scan, Databtn, reset, connect;
    EditText NameTxt;
    TextView DateTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "Inregistrare reusita: " + adaugat, Toast.LENGTH_SHORT).show();
        ...
        if(bta == null){
            ...
            if (!bta.isEnabled()) {
                ...
                switch(initiateBluetoothProcess()){
                    case 0:
                        temperatura.append("Conectat");
                        break;
                    case 1:
                        temperatura.append("Nu se poate conecta\n");
                        break;
                    case 2:
                        temperatura.append("Nu se inchide mmSocket\n");
                        break;
                    default:
                        temperatura.append("status necunoscut\n");
                        break;
                }
            }
        }
